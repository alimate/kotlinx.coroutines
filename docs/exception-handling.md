...
* [Coroutines supervision](#coroutines-supervision)
...
### Supervision job
For this purpose [SupervisorJob][SupervisorJob()] can be used. It is similar to a regular [Job][Job()] with the only exception that cancellation is propagated
...
every child should handle its exceptions by himself via already familiar to you mechanisms.
